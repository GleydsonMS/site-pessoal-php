...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input name="url" id="pagesUrl" type="text" class="form-control" placeholder="URL amigável, deixe em brando para informar a página inicial..." value="<?php echo $data['page']['url'];?>">
        </div>
    </div>
    <div class="form-group">
